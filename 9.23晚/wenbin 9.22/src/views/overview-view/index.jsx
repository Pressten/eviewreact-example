    ...
    <div className="ov-page">
      <div className="page-head">
        ...
        <div className="page-head-actions">
          <Button icon={<Icon name="download" size={14} />} onClick={() => window.print()}>
            导出报表
          </Button>
          <Button type="primary" icon={<Icon name="plus" size={14} />} onClick={() => setActiveMenu("management")}>
            新建数据集
          </Button>
        </div>
      </div>
      ...
      <div className="ov-grid-3">
        ...
        <SectionCard
          ...
          title="最近操作动态"
          extra={
            <Button size="small" type="link" onClick={() => setActiveMenu("sync")}>
              查看全部
            </Button>
          }
        >
