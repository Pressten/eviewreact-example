...
// 换肤双轨：isDark 同时切换 <body> 的 .dark（页面自定义 token，见 styles/theme-dark.css）
// 与 .aui3_1_dark（eview-react 组件 ICT3.1 暗色）；基础类 aui3_1 由 index.html 静态写在 <body> 上。
...
export function AppProvider({ children }) {
  ...
  const saveMetric = (values) => {
    ...
    const effectiveAt = values.effectiveAt ? values.effectiveAt.format("YYYY-MM-DD") : "";
    setMetrics((list) => {
