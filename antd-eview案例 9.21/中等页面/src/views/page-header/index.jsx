    ...
    <header className="page-header">
      <div className="page-header__top">
        ...
        <div className="page-header__actions">
          <TipBox direction="top" content={isDark ? "切换为浅色模式" : "切换为深色模式"}>
            <Button
              status="text"
          ...
          <Button leftIcon={<Icon name="refresh-cw" size={14} />}>刷新</Button>
          <Button leftIcon={<Icon name="download" size={14} />}>导出报告</Button>
          <Button status="primary" leftIcon={<Icon name="plus" size={14} />}>
            新建指标
          </Button>
        </div>
      </div>
