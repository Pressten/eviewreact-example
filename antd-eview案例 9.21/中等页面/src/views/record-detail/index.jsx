    ...
    { title: "完成时间", key: "finishedAt", width: 170 },
    {
      ...
      render: (_, record) => (
        <div className="row-actions">
          <TipBox direction="top" content="查看血缘溯源">
            <Button
              status="text"
              size="small"
          ...
          <TipBox direction="top" content="运行日志">
            <Button status="text" size="small" leftIcon={<Icon name="file-text" size={14} />} />
          </TipBox>
          <TipBox direction="top" content="重新调度">
            <Button status="text" size="small" leftIcon={<Icon name="rotate-ccw" size={14} />} />
          </TipBox>
        </div>
      ),
    },
