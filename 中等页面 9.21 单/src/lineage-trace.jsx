// lineage-trace.jsx — Layer 4: 三级页签「血缘溯源」
// 由采集明细下钻进入，展示上下游链路与节点明细
    ...
    { title: '更新时间', key: 'updatedAt', width: 170 },
    {
      ...
      render: () => (
        <div className="row-actions">
          <IconButton
            iconName={<AppIcon name="maximize-2" size={14} />}
            tipText="查看节点详情"
          />
          <IconButton
            iconName={<AppIcon name="share-2" size={14} />}
            tipText="分享链路"
          />
        </div>
      ),
    ...
    <div className="lineage-trace">
      ...
      <div className="table-toolbar">
        ...
        <div className="table-toolbar__extra">
          ...
          <Button leftIcon={<AppIcon name="network" size={14} />} text="全屏血缘视图" />
