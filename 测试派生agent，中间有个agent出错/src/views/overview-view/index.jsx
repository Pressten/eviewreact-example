...
import { Segmented } from "../../shared/common.jsx";
  ...
  return (
    <div className="ov-page">
      ...
      <div className="ov-stats">
        ...
        <StatCard icon="hard-drive" label="存储总量" value="5.8" unit="TB" trend={2.1} trendLabel="较上月 +0.12 TB" tone="info" onClick={() => toast.info("存储集群容量 8 TB，已用 71%")} />
        <StatCard icon="zap" label="今日 API 调用" value="48,216" unit="次" trend={12.8} trendLabel="峰值时段 10:00-11:00" tone="critical" onClick={() => toast.info("调用趋势见下方图表")} />
      ...
      <div className="ov-grid-3">
        ...
        <SectionCard
          ...
          title="最近操作动态"
          extra={
            <Button size="small" status="text" text="查看全部" onClick={() => setActiveMenu("sync")} />
          }
        >
          <div className="ov-tl">
