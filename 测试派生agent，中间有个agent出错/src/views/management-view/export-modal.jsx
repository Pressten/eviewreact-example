...
import { SimpleProgress } from "../../shared/common.jsx";
    ...
    >
      {phase === "config" && (
        <div className="ex-body">
          {ctx?.scope === "single" ? (
            ...
            <div className="ex-block">
              ...
              <RadioGroup
                ...
                value={scope}
                onChange={(a, b) => setScope(a === scope ? b : a)}
              />
            </div>
          )}
          <div className="ex-block">
          ...
          <div className="ex-block">
            <label>包含内容</label>
            <CheckboxGroup data={contentOptions} value={content} onChange={(value) => setContent(value)} />
          </div>
      ...
      {phase === "done" && (
        <div className="ex-body">
          <DivMessage display type="success" title="导出完成" enableDisposeTimeOut={false} className="ex-alert">
            <span>文件已生成并通过完整性校验，可立即下载。</span>
          </DivMessage>
          ...
          <div className="ex-footer">
            ...
            <Button
              ...
              onClick={() => toast.success("已开始下载，请留意浏览器下载栏")}
            >
              下载文件
            </Button>
          </div>
