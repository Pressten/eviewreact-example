    ...
    >
      ...
      >
        ...
        <Form.Item name="owner" label="负责人" rules={[{ required: true }]}>
          <InputSelect options={ownerOptions.map((v) => ({ value: v, text: v }))} placeholder="输入或选择负责人" />
        </Form.Item>
        ...
        <Form.Item
          ...
          label={
            <span>
              是否公开{" "}
              <TipBox content="公开后组织内所有成员可申请访问" type="simple" direction="top">
        ...
        <Form.Item name="qualityTarget" label="质量目标分" col={24}>
          <DragInput min={0} max={100} markIndexes={[0, 60, 80, 100]} />
        </Form.Item>
        ...
        <Form.Item
          label={
            <span>
              敏感字段脱敏{" "}
              <TipBox content="开启后手机号、证件号等敏感字段自动脱敏" type="simple" direction="top">
                <Icon name="info" size={13} />
              </TipBox>
            </span>
          }
