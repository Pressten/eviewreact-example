...
import { KeyValueList, SimpleProgress } from "../../shared/common.jsx";
    ...
    >
      {record ? (
        <div className="dw-body">
          <div className="dw-extra">
            <Button
              ...
              onClick={() => {
                ...
                toast.success(`已复制 ID：${record.id}`);
              }}
            >
              复制 ID
            </Button>
          ...
          <div className="dw-desc-title">基本信息</div>
          <KeyValueList
            className="dw-desc"
            columns={2}
            bordered
          ...
          <Tab
            ...
            className="dw-tabs"
          >
            <TabItem title={<span className="dw-tab"><Icon name="layers" size={13} />字段结构</span>}>
              <Table
            ...
            <TabItem title={<span className="dw-tab"><Icon name="list-checks" size={13} />变更记录</span>}>
            ...
            <TabItem title={<span className="dw-tab"><Icon name="refresh-cw" size={13} />关联任务</span>}>
