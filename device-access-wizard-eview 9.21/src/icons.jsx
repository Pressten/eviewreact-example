...
// 内联 SVG 图标组件（迁移自源项目 Lucide 硬编码表，离线可用，无需 icon-plus 名称映射）
// 方案 B（source-project-guidelines.md §3.3）：不依赖网络 fetch，也不猜 icon-plus 组件名
...
export function Icon({ name, size = 16, className = "", style }) {
  ...
  return (
    <svg
      ...
      className={className}
      aria-hidden={true}
      style={{ ...style, stroke: "currentColor", display: "inline-block", verticalAlign: "middle" }}
    >
