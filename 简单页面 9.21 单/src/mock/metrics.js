...
// 注：eview-react Select 的选项结构为 { text, value }（text 为显示文字）

export const CATEGORY_OPTIONS = [
  { text: '资源性能', value: '资源性能' },
  { text: '容量规划', value: '容量规划' },
  { text: '服务质量', value: '服务质量' },
  { text: '业务运营', value: '业务运营' },
  { text: '安全合规', value: '安全合规' },
];
...
export const DIMENSION_OPTIONS = [
  ...
  { text: '区域', value: '区域' },
  { text: '机房', value: '机房' },
  { text: '业务系统', value: '业务系统' },
  { text: '设备类型', value: '设备类型' },
  { text: '租户', value: '租户' },
];
...
export const SOURCE_OPTIONS = [
  { text: '指标中台', value: '指标中台' },
  { text: 'Prometheus', value: 'Prometheus' },
  { text: '日志平台', value: '日志平台' },
  { text: '业务库直连', value: '业务库直连' },
  { text: '手工填报', value: '手工填报' },
];

export const OWNER_OPTIONS = [
  { text: '张明 · 平台架构组', value: '张明' },
  { text: '李慧 · 基础资源组', value: '李慧' },
  { text: '王涛 · 数据平台组', value: '王涛' },
  { text: '赵磊 · 容量规划组', value: '赵磊' },
  { text: '陈晓 · 网络运维组', value: '陈晓' },
  { text: '刘洋 · 服务保障组', value: '刘洋' },
  { text: '孙倩 · 运维支撑组', value: '孙倩' },
  { text: '周航 · 业务运营组', value: '周航' },
  { text: '何静 · 增长分析组', value: '何静' },
  { text: '马俊 · 安全合规组', value: '马俊' },
];

export const POLARITY_OPTIONS = [
  { text: '正向指标（越大越好）', value: 'higher' },
  { text: '逆向指标（越小越好）', value: 'lower' },
];

export const STATUS_OPTIONS = [
  { text: '已启用', value: 'online' },
  { text: '待审核', value: 'pending' },
  { text: '需关注', value: 'warning' },
  { text: '数据异常', value: 'abnormal' },
  { text: '草稿', value: 'draft' },
...
export function decorate(metric) {
  return decorateMetric(metric);
}
