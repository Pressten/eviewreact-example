import { IconChevronUp, IconChevronDown, IconMinus } from '../icons.jsx';

// 达成率 + 环比趋势（达成率 ≥100% 达标 / ≥90% 需关注 / 其余告警）
const RATIO_TONE = [
...
function RatioValue({ ratio, trend, polarity }) {
  ...
  const TrendIcon = delta === 0 ? IconMinus : delta > 0 ? IconChevronUp : IconChevronDown;
