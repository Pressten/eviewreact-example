...
// antd → eview-react: Breadcrumb items → Crumbs data(最后一项无 url);
// Space → flex + gap;message.success → useToast().success。
export default function ConsolePage() {
  ...
  // Crumbs.title 用字符串(避免对 ReactNode 的兼容性问题);当前页为最后一项,不传 url
