    ...
    <div className="ov-page">
      ...
      <div className="page-head">
        ...
        <div className="page-head-actions">
          <Button text="导出报表" leftIcon={<Icon name="download" size={14} />} onClick={() => window.print()} />
          <Button status="primary" text="新建数据集" leftIcon={<Icon name="plus" size={14} />} onClick={() => setActiveMenu("management")} />
        </div>
      </div>
      ...
      <div className="ov-stats">
        ...
        <StatCard icon="hard-drive" label="存储总量" value="5.8" unit="TB" trend={2.1} trendLabel="较上月 +0.12 TB" tone="info" onClick={() => notify("default", "存储集群容量 8 TB，已用 71%")} />
        <StatCard icon="zap" label="今日 API 调用" value="48,216" unit="次" trend={12.8} trendLabel="峰值时段 10:00-11:00" tone="critical" onClick={() => notify("default", "调用趋势见下方图表")} />
